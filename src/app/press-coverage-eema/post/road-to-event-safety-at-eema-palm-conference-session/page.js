...
export default function Post36() {
  ...
  return (
    <>
      <PostHeader
        postHeading="‘Road To Event Safety’ At EEMA PALM Conference Session"
        postDate="May 25, 2016"
      />

      <div className=" leading-relaxed text-gray-500 text-lg py-11 ">
        {post36Data.map((data, index) => (
          <motion.p
      ...
      <div>
        <motion.a
          ...
          viewport={{ amount: 0.5 }}
          href="http://mediainfoline.com/article/road-to-event-safety-at-eema-palm-conference-session/"
