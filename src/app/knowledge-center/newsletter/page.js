...
export default function KcNewsletterPage() {
  ...
  return (
    <>
      ...
      >
        <h2 className=" text-black text-3xl md:text-4xl font-bold tracking-tight text-center my-20 w-fit mx-auto px-4 border-l-4 border-r-4 border-orange-600 ">
          Newsletter
        </h2>
