...
export default function EemaxTCPage() {
  return (
    <section className=" ">
      <main className=" py-16 text-black px-7 md:px-44 [&_p]:text-gray-600 [&_li]:text-gray-600  ">
        ...
        <div className=" py-7 mt-11 ">
              ...
              <tbody className="bg-white divide-y divide-gray-100 text-sm text-gray-800">
                <tr>
                  ...
                  <td className="py-4 px-4">
                    Personnel from EEMA and / or organizers who are responsible
                    for the overall conduct of the Awards
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="py-4 px-4 text-orange-500 underline break-all">
                    <a
                      href="https://www.eemaindia.com/eemaxglobal/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      https://www.eemaindia.com/eemaxglobal/
                    </a>
                  </td>
                </tr>
                <tr>
          ...
          <ul className=" list-disc pl-9 space-y-4 mt-9 [&_li]:pl-2 leading-relaxed ">
            ...
            <li>
              The Award categories and number of winners may be
              changed/modified/split/merged/increased or cancelled by the Jury
              based on the number and quality of entries received in each
              category
            </li>
            <li>
              The rewards may be changed/modified / split / merged/increased or
              cancelled at the sole discretion of awards management
            </li>
            <li>
        ...
        <div className=" space-y-2 mt-9 ">
          ...
          <ul className=" list-disc pl-9 space-y-4 mt-6 [&_li]:pl-2 leading-relaxed ">
            <li>
              EEMAX Global Awards 2025 are open for all experiential projects
              and stakeholders in the event and entertainment management
              industry. The participating organization must have at least 1
              complete year of office and business operations as on March 31,
              2025.
            </li>
            <li>
            ...
            <li>
              ...
              category; however, they can nominate the same event in multiple
              categories
            </li>
            <li>
        ...
        <div className=" space-y-2 mt-9 ">
          ...
          <ul className=" list-disc pl-9 space-y-4 mt-6 [&_li]:pl-2 leading-relaxed ">
            ...
            <li>
              The Awards Management reserves the right to verify the
              authenticity and relevance of all submitted materials.
            </li>
          </ul>
        </div>
        ...
        <div className=" space-y-2 mt-9 ">
          ...
          <ul className=" list-disc pl-9 space-y-4 mt-6 [&_li]:pl-2 leading-relaxed ">
            <li>
              ...
              are of legal age and mental capacity) and eligible to enter into
              this legally binding agreement on Participant
            </li>
            <li>
            ...
            <li>
              ...
              partners of Management including the Management for consideration
              for the Awards are solely owned by the awards management and do
              not infringe upon any other individual or organizational rights
              (including, without limitation, intellectual property rights).
              Participant shall be completely responsible for handling claim of
              infringement or alleged infringement by any third party and shall
              indemnify awards management entities (in India or abroad) and the
              Awards Management from any claims, costs or damages from
              infringement or alleged infringement of any third-party rights
              including intellectual property right or the defines of a claim or
              any costs payable thereof
            </li>
            <li>
              Participant must enter the Awards at their own will and the
              Management are not in any way obligated or liable for any loss or
            ...
            <li>
              ...
              exclusive jurisdiction of the courts of competent jurisdiction at
              Mumbai, India
            </li>
            <li>
              The Participants indemnify awards management, its employees,
              officers, contractors, partner or other persons used by them in
              ...
              third party in connection with the Participants participation in
              or winning the Awards, which is inconsistent with any of the
              warranties and representations made by the Participants, or due to
              breach of these Terms and shall reimburse awards management for
              any loss, costs, expense, or damage to which said indemnity
              applies. awards management shall give the Participant prompt
              written notice of any claim or actions covered by this indemnity,
              and the Participant shall have the right, at its own expense, to
              participate in any such action
            </li>
            <li>
              Decision of Management on all matters is final and binding on all
              Participants and no correspondence will be entertained on the same
            </li>
            <li>
              In the event these Terms do not cover any question or complaint in
              relation to the Awards, the same will be concluded on by the
              Awards Management (for all other issues) or an independent body or
              legal team as appointed by the Awards Management and deemed
              necessary
            </li>
            <li>
            ...
            <li>
              ...
              following email address: email address, awards management shall
              endeavour to the best of its ability to respond thereto.
            </li>
          </ul>
        </div>
