      ...
      <section className="py-16 px-4 md:px-10 bg-[#fff7ed]">
        <div className="max-w-5xl mx-auto space-y-10">
          ...
          <p className="text-sm md:text-base text-gray-700 text-center leading-relaxed">
            <span className="font-semibold">Note:</span> 18% GST and bank
            charges will be additional to the above amount. Mandatory to share
            GST number with entry fee. Last Nomination Date is{" "}
            <strong>6th July 2025 (Sunday)</strong>.
          </p>
        </div>
      </section>
    </motion.section>
